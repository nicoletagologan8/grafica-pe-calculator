...
//#define RY_JF 0.01
//
//#define NRITER_MS 5000
//#define MODMAX_MS 10000000
//
//#define RX_MS 0.01
//#define RY_MS 0.01
//
...
//
//		glBegin(GL_POINTS);
//		for (double x = xmin; x <= xmax; x += RX_MS)
//			for (double y = ymin; y <= ymax; y += RY_MS)
//			{
//				CComplex c(x, y);
//				int r = isIn(c);
//				if (r == 0)
...
//				}
//				else if (r < m.nriter / 4)
//				{
//					glColor3f(0, 0, r * (1.2) / m.nriter);
//					glVertex3d(x / 2, y / 2, 0);
//				}
//				else
//				{
//					glColor3f(0, r * (1.0) / m.nriter,0);
//					glVertex3d(x / 2, y / 2, 0);
//				}
//			}
//
